...
const AddTourForm = ({ showForm, onCancel, allCategory, onSuccess }) => {
        ...
        try {
            ...
            Object.keys(data).forEach((key) => {
                if (key === "images") {
                    ...
                    if (data[key]) {
                        formData.append("category_id", data[key].value); // Map to category_id
                    }
                } else if (key === "sub_category") {
                    if (data[key]) {
                        formData.append("sub_category_id", data[key].value); // Map to sub_category_id
                    }
            ...
            await axios.post(route("ourtour.store"), formData, {
